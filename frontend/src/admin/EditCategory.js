...
const EditCategory = () => {
    ...
    // Get category from state passed via navigation
    ...
    const [preview, setPreview] = useState(categoryToEdit?.categoryimage ? `http://localhost:5510/category/${categoryToEdit.categoryimage}` : null);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`http://localhost:5510/grocery/category/edit/${categoryToEdit._id}`, {
                method: 'PUT',
                body: formData
            });
                ...
                <nav className="flex-1 px-4 space-y-2 mt-4 overflow-y-auto">
                    {[
                        ...
                        <button
                            ...
                            className={`w-full flex items-center gap-4 px-4 py-3 rounded-2xl font-bold transition-all ${item.id === 'categories'
            ...
            <main className="flex-1 overflow-y-auto p-4 md:p-10 relative">
                ...
                <header className="flex justify-between items-center mb-10">
                    <div>
                        ...
                        <p className="text-gray-500 font-medium">Update category details</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                onChange={handleChange}
                                className="w-full p-4 bg-gray-50 border border-transparent rounded-2xl focus:bg-white focus:border-black outline-none transition-all font-medium resize-none"
